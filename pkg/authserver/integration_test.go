...
func TestIntegration_MultiUpstreamSequentialChain(t *testing.T) {
	...
	// Both providers should have different upstream subjects (they are different IDPs)
	assert.NotEmpty(t, tokens1.UpstreamSubject, "provider-1 should have upstream subject")
	assert.NotEmpty(t, tokens2.UpstreamSubject, "provider-2 should have upstream subject")
}
