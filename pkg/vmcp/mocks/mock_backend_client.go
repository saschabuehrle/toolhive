...
//
//	mockgen -destination=mocks/mock_backend_client.go -package=mocks -source=types.go BackendClient HealthChecker ConnectionFlusher
//
...
// MockConnectionFlusher is a mock of ConnectionFlusher interface.
type MockConnectionFlusher struct {
	ctrl     *gomock.Controller
	recorder *MockConnectionFlusherMockRecorder
	isgomock struct{}
}

// MockConnectionFlusherMockRecorder is the mock recorder for MockConnectionFlusher.
type MockConnectionFlusherMockRecorder struct {
	mock *MockConnectionFlusher
}

// NewMockConnectionFlusher creates a new mock instance.
func NewMockConnectionFlusher(ctrl *gomock.Controller) *MockConnectionFlusher {
	mock := &MockConnectionFlusher{ctrl: ctrl}
	mock.recorder = &MockConnectionFlusherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockConnectionFlusher) EXPECT() *MockConnectionFlusherMockRecorder {
	return m.recorder
}

// FlushIdleConnections mocks base method.
func (m *MockConnectionFlusher) FlushIdleConnections(backendID string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "FlushIdleConnections", backendID)
}

// FlushIdleConnections indicates an expected call of FlushIdleConnections.
func (mr *MockConnectionFlusherMockRecorder) FlushIdleConnections(backendID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FlushIdleConnections", reflect.TypeOf((*MockConnectionFlusher)(nil).FlushIdleConnections), backendID)
}
